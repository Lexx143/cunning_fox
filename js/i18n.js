...
const I18N = {
    ru: {
        ...
        setup_sub: 'Лис-воришка стащил пирог! Кто ведёт расследование?',
        ...
        dossier_released: 'Этот лис уже отпущен на свободу.',
        btn_accuse: 'Обвинить!',
        btn_release: 'Отпустить',
        btn_close: 'Закрыть',
        stamp_released: 'СВОБОДЕН',
        ...
        rule2_t: 'Кубики', rule2: 'В свой ход выберите цель и бросайте кубики (до 3 раз). Соберите три «глаза» — откроете 2 карты. Три «лапки» — пойдёте по полю. Не собрали — лис убегает на 3 шага!',
        ...
        tut_eyes: 'Здесь выбирают цель хода. Сейчас выбраны «глаза» — они открывают карты подозреваемых.',
        tut_roll: 'А теперь жми «Бросить!»',
        tut_open_more: 'Ура, три глаза! Теперь открой ещё 2 карты подозреваемых.',
        tut_roll_again: 'Отлично! Снова жми «Бросить кубики».',
        tut_paws: 'Теперь цель — «следы», они дают шаги по полю.',
        tut4: 'Выбери цель: «глаза» — открыть ещё карты, «лапки» — ходить по полю. Кубики можно бросать до 3 раз, совпавшие сохраняются.',
    ...
    en: {
        ...
        setup_sub: 'A sneaky fox stole the pie! Who is on the case?',
        ...
        tut_eyes: 'This is where you pick the target. Right now it is “eyes” — they flip suspect cards.',
        tut_roll: 'Now tap “Roll!”',
        tut_open_more: 'Hooray, three eyes! Now flip 2 more suspect cards.',
        tut_roll_again: 'Great! Tap “Roll the dice” again.',
        tut_paws: 'Now the target is “paws” — they give you steps on the board.',
