...
const I18N = {
    ru: {
        ...
        tut_eyes: 'Начнём с «глаз» — они открывают карты подозреваемых. Жми «Бросить!»',
        tut_open_more: 'Ура, три глаза! Теперь открой ещё 2 карты подозреваемых.',
        tut_roll_again: 'Отлично! Снова жми «Бросить кубики».',
        tut_paws: 'Теперь цель — «следы», они дают шаги по полю. Бросай!',
    ...
    en: {
        ...
        tut_eyes: 'Let us start with “eyes” — they flip suspect cards. Tap “Roll!”',
        tut_open_more: 'Hooray, three eyes! Now flip 2 more suspect cards.',
        tut_roll_again: 'Great! Tap “Roll the dice” again.',
        tut_paws: 'Now the target is “paws” — they give you steps. Roll!',
